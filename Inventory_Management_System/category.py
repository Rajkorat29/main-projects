...
def category_page(root, mycursor, conn):
    ...
    # Frame
    category_window = Frame(root, width=1325, height=755, bg='#E4E0E1')
    category_window.place(x=200, y=100)

    backImage = PhotoImage(file='back.png')
    backButton = Button(category_window, image=backImage, bd=0, bg='#E4E0E1', cursor='hand2',command=lambda: category_window.destroy())
    backButton.image = backImage
    backButton.place(x=10, y=35)

    titleLabel = Label(category_window, text='Manage Product Category', font=('times new roman', 16, 'bold'), bg='#493628',fg='#E4E0E1')
    titleLabel.place(x=0, y=0, relwidth=1)

    logo = PhotoImage(file='product_category.png')
    label = Label(category_window, image=logo, bg='#E4E0E1')
    label.image = logo
    label.place(x=80, y=120)

    # details frame
    detailsFrame = Frame(category_window, bg='#E4E0E1')
    detailsFrame.place(x=650, y=100)

    categoryIdLabel = Label(detailsFrame, text='Category ID.', font=('times new roman', 13,'bold'), bg='#E4E0E1')
    ...
    categoryNameLabel = Label(detailsFrame, text='Category Name.', font=('times new roman', 13,'bold'), bg='#E4E0E1')
    ...
    descriptionLabel = Label(detailsFrame, text='Description.', font=('times new roman', 13,'bold'), bg='#E4E0E1')
    ...
    # buttons
    buttonFrame = Frame(category_window, bg='#E4E0E1')
    buttonFrame.place(x=810, y=340)

    addButton = Button(buttonFrame, text='Add', font=('times new roman', 12, 'bold'), width=8, fg='#E4E0E1',
                       bg='#493628', cursor='hand2', command=add_data)
    addButton.grid(row=0, column=0, padx=8)

    deleteButton = Button(buttonFrame, text='Delete', font=('times new roman', 12, 'bold'), width=8, fg='#E4E0E1',
                          bg='#493628', cursor='hand2', command=delete_data)
    deleteButton.grid(row=0, column=2, padx=8)

    clear_button = Button(buttonFrame, text='Clear', font=('times new roman', 12,'bold'), width=8, cursor='hand2', bg='#493628', fg='#E4E0E1',command=clear)
    clear_button.grid(row=0, column=3, padx=8)

    treeviewFrame = Frame(category_window, bg='#E4E0E1')
    treeviewFrame.place(x=710, y=400, height=200,width=500)
