...
def sales_page(root, mycursor, conn):
    ...
    def show_sales_report():
      ...
      #gui start from hear
    sales_window = Frame(root, width=1325, height=755, bg='#E4E0E1')
    sales_window.place(x=200, y=100)


    titleLabel = Label(sales_window, text='Customer Bill and Sales Analysis', font=('times new roman', 15,'bold'), bg='#493628',fg='#E4E0E1')
    titleLabel.place(x=0, y=0, relwidth=1)

    backImage = PhotoImage(file='back.png')
    backButton = Button(sales_window, image=backImage, bd=0, bg='#E4E0E1', cursor='hand2', command=lambda: sales_window.destroy())
    backButton.image = backImage
    backButton.place(x=10, y=35)


    searchFrame = Frame(sales_window, bg='#E4E0E1')
    searchFrame.place(x=400, y=80)

    invoiceLabel = Label(searchFrame, text='Invoice No.', font=('times new roman', 12), bg='#E4E0E1')
    invoiceLabel.grid(row=0, column=0, padx=20)
    searchEntry = Entry(searchFrame, font=('times new roman', 12), bg='white', width=14)
    searchEntry.grid(row=0, column=1)
    searchButton = Button(searchFrame, text='Search Bill', font=('times new roman', 12, 'bold'), bg='#493628', fg='white',
    ...
    billFrame.place(x=400, y=130, height=350, width=420)

    billLabel = Label(billFrame, text='Customer Bill Area', font=('times new roman', 14, 'bold'), bg='#493628', fg='white')
    ...
    rightFrame = Frame(sales_window,bd=2, bg='#E4E0E1')
    rightFrame.place(x=850, y=68)
    ...
    daily_sales_label = Label(rightFrame, text="", font=("times new roman", 12), bg='#E4E0E1')
    ...
    buttonFrame=Frame(sales_window,bg='#E4E0E1')
    buttonFrame.place(x=450,y=510)
    exportButton = Button(buttonFrame, text='Export', font=('times new roman', 12, 'bold'), width=8, fg='white',
                         bg='#493628', cursor='hand2', command=export_to_excel)
    exportButton.grid(row=0, column=0,padx=20)

    show_report_button = Button(buttonFrame, text="Show Report", font=('times new roman', 12, 'bold'), bg='#493628',
    ...
    resetButton = Button(buttonFrame, text='Reset', font=('times new roman', 12, 'bold'), width=8, fg='white',
                         bg='#493628', cursor='hand2', command=reset)
