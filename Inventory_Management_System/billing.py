...
def bill_top():
    ...
    bill_temp = f'''
    \t\t\tStockApp-Inventory
    \t\t Phone No. 6352614496, Rajkot,360005
    {str("=" * 54)}
...
root.geometry('1525x755+0+0')
root.config(bg='#E4E0E1')
icon = PhotoImage(file='P1logo.png')
titleLabel = Label(root, text='  Inventory Management System', image=icon, compound=LEFT,
                   font=('times new roman', 40, 'bold'), bg='#E4E0E1', fg='#493628', anchor='w', padx=20)
titleLabel.place(x=0, y=0, relwidth=1, height=70)
logoutButton = Button(root, text='Logout', font=('times new roman', 20, 'bold'), bg='#493628', fg='#E4E0E1',cursor='hand2', command=logout)
logoutButton.place(x=1350, y=10)
subtitleLabel = Label(root, text='Date:DD-MM-YYYY\t\t Time: HH:MM:SS',
                      font=('times new roman', 15), bg='#D6C0B3', fg='black')
subtitleLabel.place(x=0, y=70, relwidth=1, height=30)

# left menu

leftFrame = Frame(root, bd=2, relief=RIDGE, bg='#E4E0E1')
leftFrame.place(x=10, y=150)

titleLabel = Label(leftFrame, text='All Products', font=('times new roman', 15, 'bold'), bg='#493628', fg='white')
titleLabel.grid(row=0, column=0, columnspan=4, sticky='news', pady=(0, 10))

searchLabel = Label(leftFrame, text='Product Name', font=('times new roman', 13, 'bold'), bg='#E4E0E1')
searchLabel.grid(row=1, column=0,padx=10, pady=10)

searchEntry = Entry(leftFrame, font=('times new roman', 13), bg='white', width=22)
searchEntry.grid(row=1, column=1, padx=10)


searchButton = Button(leftFrame, text='Search', font=('times new roman', 12, 'bold'), bg='#493628', fg='white',
                      cursor='hand2', width=8, command=search)
searchButton.grid(row=1, column=2, padx=(10,10))

showButton = Button(leftFrame, text='Show All', font=('times new roman', 12, 'bold'), width=8, fg='white',
                    bg='#493628', cursor='hand2', command=show_data)
showButton.grid(row=1, column=3,padx=10)

treeviewFrame = Frame(root, bg='white', bd=2, relief=RIDGE)
treeviewFrame.place(x=10, y=250, height=415, width=560)
...
middleTopFrame = Frame(root, bg='#E4E0E1', bd=2, relief=RIDGE)
middleTopFrame.place(x=600, y=150)

titleLabel = Label(middleTopFrame, text='Customer Details', font=('times new roman', 14, 'bold'), bg='#493628', fg='white')
titleLabel.grid(row=0, column=0, columnspan=4, sticky='news', pady=(0, 10))

nameLabel = Label(middleTopFrame, text='Name', font=('times new roman', 12, 'bold'), bg='#E4E0E1')
nameLabel.grid(row=1, column=0, padx=(10, 0))

nameEntry = Entry(middleTopFrame, font=('times new roman', 12), bg='white', width=16)
nameEntry.grid(row=1, column=1, padx=15)

contactLabel = Label(middleTopFrame, text='Contact No.', font=('times new roman', 12, 'bold'), bg='#E4E0E1')
contactLabel.grid(row=1, column=2)

contactEntry = Entry(middleTopFrame, font=('times new roman', 12), bg='white', width=16)
contactEntry.grid(row=1, column=3, padx=10, pady=10)

calculatorFrame = Frame(root, bg='white', bd=2, relief=RIDGE)
calculatorFrame.place(x=600, y=250)
...
titleLabel = Label(calculatorFrame, text='Calculator', font=('times new roman', 15, 'bold'))
titleLabel.grid(row=0, column=0, columnspan=4, sticky='news')
calculatorField = Entry(calculatorFrame, font=('times new roman', 18, 'bold'), width=15, bd=4, justify=RIGHT)
calculatorField.grid(row=1, column=0, columnspan=4)
calculatorField.insert(0, '0')

button7 = Button(calculatorFrame, text='7', font=('times new roman', 12, 'bold'), bd=2, width=4, height=2,
                 command=lambda: buttonClick('7'))
button7.grid(row=2, column=0)

button8 = Button(calculatorFrame, text='8', font=('times new roman', 12, 'bold'), bd=2, width=4, height=2,
                 command=lambda: buttonClick('8'))
button8.grid(row=2, column=1)

button9 = Button(calculatorFrame, text='9', font=('times new roman', 12, 'bold'), bd=2, width=4, height=2
                 , command=lambda: buttonClick('9'))
button9.grid(row=2, column=2)

buttonPlus = Button(calculatorFrame, text='+', font=('times new roman', 12, 'bold'), bd=2, width=4, height=2
                    , command=lambda: buttonClick('+'))
buttonPlus.grid(row=2, column=3)

button4 = Button(calculatorFrame, text='4', font=('times new roman', 12, 'bold'), bd=2, width=4, height=2
                 , command=lambda: buttonClick('4'))
button4.grid(row=3, column=0)

button5 = Button(calculatorFrame, text='5', font=('times new roman', 12, 'bold'), bg='white', bd=2, width=4, height=2
                 , command=lambda: buttonClick('5'))
button5.grid(row=3, column=1)

button6 = Button(calculatorFrame, text='6', font=('times new roman', 12, 'bold'), bg='white', bd=2, width=4, height=2
                 , command=lambda: buttonClick('6'))
button6.grid(row=3, column=2)

buttonMinus = Button(calculatorFrame, text='-', font=('times new roman', 12, 'bold'), bd=2, width=4, height=2
                     , command=lambda: buttonClick('-'))
buttonMinus.grid(row=3, column=3)

button1 = Button(calculatorFrame, text='1', font=('times new roman', 12, 'bold'), bd=2, width=4, height=2
                 , command=lambda: buttonClick('1'))
button1.grid(row=4, column=0)

button2 = Button(calculatorFrame, text='2', font=('times new roman', 12, 'bold'), bg='white', bd=2, width=4, height=2
                 , command=lambda: buttonClick('2'))
button2.grid(row=4, column=1)

button3 = Button(calculatorFrame, text='3', font=('times new roman', 12, 'bold'), bg='white', bd=2, width=4, height=2
                 , command=lambda: buttonClick('3'))
button3.grid(row=4, column=2)

buttonMult = Button(calculatorFrame, text='*', font=('times new roman', 12, 'bold'), bd=2, width=4, height=2
                    , command=lambda: buttonClick('*'))
buttonMult.grid(row=4, column=3)

buttonAns = Button(calculatorFrame, text='Ans', font=('times new roman', 12, 'bold'), bd=2, width=4, height=2,
                   command=answer)
buttonAns.grid(row=5, column=0)

buttonClear = Button(calculatorFrame, text='Clear', font=('times new roman', 12, 'bold'), bd=2, width=4, height=2
                     , command=clear_field)
buttonClear.grid(row=5, column=1)

button0 = Button(calculatorFrame, text='0', font=('times new roman', 12, 'bold'), bd=2, width=4, height=2
                 , command=lambda: buttonClick('0'))
button0.grid(row=5, column=2)

buttonDiv = Button(calculatorFrame, text='/', font=('times new roman', 12, 'bold'), bd=2, width=4, height=2,
                   command=lambda: buttonClick('/'))
buttonDiv.grid(row=5, column=3)

treeFrame = Frame(root, bg='white', bd=2, relief=RIDGE)
treeFrame.place(x=808, y=250, height=282, width=250)

mycartProductLabel = Label(treeFrame, text='My Cart\tTotal Products: 0', font=('times new roman', 13, 'bold'), anchor='w')
...
middleBottomFrame = Frame(root, bg='#E4E0E1', bd=2, relief=RIDGE)
middleBottomFrame.place(x=600, y=550)

prodnameLabel = Label(middleBottomFrame, text='Product Name', font=('times new roman', 12, 'bold'), bg='#E4E0E1')
prodnameLabel.grid(row=0, column=0, padx=(10, 0), sticky='w')

prodnameEntry = Entry(middleBottomFrame, font=('times new roman', 12), bg='white', width=16, state='readonly')
prodnameEntry.grid(row=1, column=0, padx=10)

priceperqtyLabel = Label(middleBottomFrame, text='Price', font=('times new roman', 12, 'bold'), bg='#E4E0E1')
priceperqtyLabel.grid(row=0, column=1, sticky='w')

priceperqtyEntry = Entry(middleBottomFrame, font=('times new roman', 12), bg='white', width=16, state='readonly')
priceperqtyEntry.grid(row=1, column=1, padx=10, pady=5)

qtyLabel = Label(middleBottomFrame,text='Quantity', font=('times new roman', 12, 'bold'), bg='#E4E0E1')
qtyLabel.grid(row=0, column=2, sticky='w')

qtyEntry = Entry(middleBottomFrame, font=('times new roman', 12), bg='white', width=16)
qtyEntry.grid(row=1, column=2, padx=10)

instockLabel = Label(middleBottomFrame, text='In Stock: 0', font=('times new roman', 12, 'bold'), bg='#E4E0E1')
instockLabel.grid(row=2, column=0)

buttonFrame = Frame(middleBottomFrame, bg='#E4E0E1')
buttonFrame.grid(row=2, columnspan=2, pady=10, column=1)

clearButton = Button(buttonFrame, text='Clear', font=('times new roman', 12, 'bold'), bg='#493628', fg='white',
...
addupdateButton = Button(buttonFrame, text='Add/Update Cart', font=('times new roman', 12, 'bold'), fg='white',
                         bg='#493628', cursor='hand2', width=16, command=add_update_cart)
addupdateButton.grid(row=0, column=1, padx=10)

rightTopFrame = Frame(root, bg='white', bd=2, relief=RIDGE)
rightTopFrame.place(x=1080, y=150)

titleLabel = Label(rightTopFrame, text='Customer Billing Area', font=('times new roman', 15, 'bold'), bg='#493628', fg='white')
titleLabel.grid(row=0, column=0, columnspan=4, sticky='news')
scrolly = Scrollbar(rightTopFrame, orient=VERTICAL)
textarea = Text(rightTopFrame, font=('times new roman', 10,), width=66, height=23, yscrollcommand=scrolly.set,bg='white',
                state=DISABLED)
...
rightBottomFrame = Frame(root, bg='#E4E0E1')
rightBottomFrame.place(x=1080, y=540)
...
taxLabel.grid(row=0, column=1, padx=15)
...
generateButton = Button(rightBottomFrame, text='Generate Bill', font=('times new roman', 11, 'bold'), fg='white',
                        bg='#493628', cursor='hand2', width=13, height=2, command=generate_bill)
generateButton.grid(row=1, column=0)

printButton = Button(rightBottomFrame, text='Print', font=('times new roman', 11, 'bold'), fg='white',
                     bg='#493628', cursor='hand2', width=13, height=2, command=print_bill)
printButton.grid(row=1, column=1, padx=15)

clearAllButton = Button(rightBottomFrame, text='Clear All', font=('times new roman', 11, 'bold'), fg='white',
                        bg='#493628', cursor='hand2', width=13, height=2, command=clear_all)
